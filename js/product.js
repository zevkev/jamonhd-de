...
function updateMeta(product, imageUrl) {
  document.title = `${product.name} | Jamon Shop`;
  const desc = `${product.name} — im Jamon Merch Shop. Sicher bestellen über Fourthwall.`;
  document.querySelector('meta[name="description"]')?.setAttribute("content", desc);
  document.querySelector('meta[property="og:title"]')?.setAttribute("content", `${product.name} | Jamon Shop`);
  ...
  const canonicalUrl = `https://jamonhd.de/shop/${product.slug}`;
