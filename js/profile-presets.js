...
// Solid mat backgrounds a visitor can pick for their own profile page.
...
// here, not blue), so every one of the site's existing grid/texture layers
// keeps working unmodified on top of it. A gradient would silently fail
// there (background-color never accepts one), so "Sonnenuntergang" is a
// warm solid instead of the literal gradient its name might suggest.
