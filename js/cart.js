...
const STORAGE_KEY = "jamon-cart-id";
// Fourthwall's hosted checkout lives on whichever domain is connected as
// this shop's custom domain in Settings → Domain -- shop.jamonhd.de
// (confirmed live via DNS: that subdomain's A record already points at
// Fourthwall's own IP). Keep in sync if the connected domain ever changes.
const CHECKOUT_DOMAIN = "shop.jamonhd.de";
