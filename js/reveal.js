...
// js/watchlist.js, js/account.js's watchlist preview) never triggered it at
// all -- those pages only ever looked "revealed" because css/shop.css's
// .product-card and css/youtube.css's .vod-card additionally carried their
// own `animation: fadeUp 0.5s ease both;`, which fires immediately on
// insertion regardless of scroll position. That's what made every one of
// those pages look static once you'd scrolled past the very top:
// everything below the fold had already faded in before you ever saw it,
// instead of animating in as each card actually entered the viewport.
